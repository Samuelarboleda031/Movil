...
path = r'c:\Users\samue\OneDrive\Escritorio\Proyectos\Movil\lib\screens\agendamiento_form_screen.dart'
try:
...
'''
    ...
    content = recalcular_re.sub(new_recalcular, content)
