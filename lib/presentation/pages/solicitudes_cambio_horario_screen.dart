                  ...
                  ? ListView(children: [
                      ...
                      const Center(
                        child: Column(children: [
                          ...
                          SizedBox(height: 12),
                          Text('No hay solicitudes', style: TextStyle(color: AppColors.grey)),
                        ]),
                      ),
                    ])
                  : ListView.builder(
                      ...
                      itemBuilder: (_, i) => _buildCard(_solicitudes[i]),
                    ),
            ),
    );
  }
            ...
            if (s.sugerencias.isNotEmpty) ...[
              ...
              ...s.sugerencias.map((sg) => Padding(
                ...
                child: Row(children: [
                  ...
                  const SizedBox(width: 6),
                  Text(
                    '${sg.diaSugerido.day}/${sg.diaSugerido.month}/${sg.diaSugerido.year}  ${sg.horaInicio}–${sg.horaFin}',
              ...
              Expanded(child: GestureDetector(
                ...
                child: Container(
                  ...
                  child: Column(children: [
                    ...
                    Text(_fmt(_horaInicio), style: const TextStyle(color: AppColors.white, fontWeight: FontWeight.bold, fontSize: 18)),
                  ]),
                ),
              )),
              ...
              Expanded(child: GestureDetector(
                ...
                child: Container(
                  ...
                  child: Column(children: [
                    ...
                    Text(_fmt(_horaFin), style: const TextStyle(color: AppColors.white, fontWeight: FontWeight.bold, fontSize: 18)),
                  ]),
                ),
              )),
            ]),
